# Code Repository for Crafting an Error Handling Strategy (.NET)
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/temporalio/edu-errstrat-dotnet-code)
